...
import { HostelfooterComponent } from '../hostelfooter/hostelfooter.component';
import { filter, Subscription } from 'rxjs';
import { HostelsidebarComponent } from '../hostelsidebar/hostelsidebar.component';

@Component({
  selector: 'app-hostellanding',
  standalone: true,
  imports: [CommonModule,RouterModule, HostelheaderComponent, HostelfooterComponent, HostelsidebarComponent],
  templateUrl: './hostellanding.component.html',
  styleUrl: './hostellanding.component.scss'
})
export class HostellandingComponent implements OnInit {
  header!:boolean
  screenWidth:any;
